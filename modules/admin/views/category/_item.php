...
<div class="card custom-card border h-100" style="background-color: #f8f9fa;">
    <div class="card-body p-2 d-flex flex-column justify-content-between">
        ...
        <div class="d-flex gap-3 justify-content-between mt-3">
            <?= Html::a('<i class="fas fa-edit"></i> Изменить', ['ajax-update', 'id' => $model->id], ['class' => 'btn btn-outline-success rounded-pill btn-wave waves-effect waves-light update-category-btn', 'data-id' => $model->id]) ?>
